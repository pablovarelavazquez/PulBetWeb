...
<div id="search-form">
	...
	<form action="<%=ControllerPaths.EVENTO%>" method="post">
		...
		<input type="hidden" name="<%=ParameterNames.ACTION%>"
			value="<%=Actions.BUSCADOR%>"> <label><fmt:message
				key="participante" bundle="${messages}" /> </label>
		<c:if test="${not empty participante}">
			<input name="participante" type="text" value="${participante}">
		</c:if>
		<c:if test="${empty participante}">
			<input name="<%=ParameterNames.PARTICIPANTE%>" type="text">
		</c:if>
		...
		<label><fmt:message key="deporte" bundle="${messages}" /> </label> <select
			id="searchdeporte" name="<%=ParameterNames.DEPORTE%>">
			<option></option>
		...
		<select id="searchcompeticion" name="<%=ParameterNames.COMPETICION%>">
			<option></option>
		...
		</label> <input name="<%=ParameterNames.FECHA_DESDE%>" type="date">
		...
		<label><fmt:message key="hasta" bundle="${messages}" /> </label> <input
			name="<%=ParameterNames.FECHA_HASTA%>" type="date">
